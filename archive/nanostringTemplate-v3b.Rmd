...
file.folder <- "../Shiny-NanoTube/data/GSE132946"
...
groups <- as.character(read.delim("../Shiny-NanoTube/data/GroupLabels-GSE132946.txt", header = FALSE))
...
makeDiffExprFile(limmaResults, 
                 filename = paste0(file.folder, "../test.txt"))
...
mHG.postprocessing.xlsx(genesetResults, leadingEdge, limmaResults, 
                     join.threshold = 0.5, filename="test.xlsx")
