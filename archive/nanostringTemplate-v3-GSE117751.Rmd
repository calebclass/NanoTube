...
file.folder <- "data/GSE117751/GSE117751_RAW/"
...
sampleTab <- "data/GSE117751/GSE117751_sample_data.csv"
#test <- read.csv("data/GSE117751/GSE117751_sample_data.csv")
...
nanostringData <- processNanostringData(file.folder,
                                        sampleTab = sampleTab, idCol = "GEO_Accession",  groupCol = "Sample_Diagnosis", replicateCol = NULL,
...
genesetResults <- mHG.genesets.multi(limmaResults, geneset.file,
                               t_thresh = 1, numReq_overall = 10, numReq_inSet = 5)
